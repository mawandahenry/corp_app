    ...
    <Modal
      ...
      <View style={styles.modalContainer}>
        ...
        <View style={styles.controls}>
          {isUpdating && <ActivityIndicator size={'large'} color={'blue'} />}
          {added && (
            <View style={styles.item}>
              <Icon name="check" color={'blue'} size={normalize(50)} />
              <Text style={styles.itemText}>Item successfully added</Text>
            </View>
          )}
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  item: {flexDirection: 'row', justifyContent: 'center', alignItems: 'center'},
  itemText: {
    color: 'blue',
